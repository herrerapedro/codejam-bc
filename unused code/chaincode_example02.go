...
func (t *SimpleChaincode) Init(stub shim.ChaincodeStubInterface, function string, args []string) ([]byte, error) {
	...
	// var Aval string //testing string assets
	var Bval, Cval, Dval int // Asset holdings
	var Aval string //, Bval, Cval, Dval string //assets
	var err error
...
// everything below is the trade function
	...
	if function == "jarman" {
		return t.jarman(stub,"jarman",args)
	}
...
//testing function builds
func (t *SimpleChaincode) jarman(stub shim.ChaincodeStubInterface, function string, args []string) ([]byte, error) {
